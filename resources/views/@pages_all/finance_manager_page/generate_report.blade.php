...
<body class="hold-transition sidebar-mini layout-fixed"> @include('@pages_all.admin_page.navbar') <div class="row-fluid">
        @include('@pages_all.finance_manager_page.sidebar_generate_report') <div class="span8" style="width:80%;margin-left:17%;">
            <div class="row-fluid">
                <div class="wrapper">
                    <div class="content-wrapper">
                        <div class="content-header">
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <form action="{{ url('/fm_generate_report') }}" method="post"
                                        style="margin-top: 2%;">
                                        @csrf
                                        <div class="control-group"
                                            ...
                                            <div class="controls" style="margin-top:7%;">
                                                ...
                                                <button style="" name="report" id="print"
                                                    class="btn btn-success" style="font-family: all;">
                                                    <i class="icon-plus"></i><b><strong>
                                                            {{ __('payment.report') }}</strong></b></button>
                                            </div>
                                        </div>
                                    </form>
                                    @if ($report == 'yes')
                                        <div class="navbar navbar-inner block-header" style="margin-top:0%; ;">
                                            <div class="alert alert-info" style="font-family: all;font-size:large;">
                                                <i class="icon-info-sign"></i><b> {{ $year }} <strong>
                                                        {{ __('payment.monthly_expense_report') }}</strong>
                                                </b>
                                            </div>
                                        </div>
                                </div>
                    ...
                    @else
                        <div class="navbar navbar-inner block-header" style="margin-top:0%; ;">
                            <div class="alert alert-info" style="font-family: all;font-size:large;">
                                <i class="icon-info-sign"></i><b>
                                    <strong>{{ __('payment.monthly_expense_report') }}</strong></b>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    </script> @include('home_page.footer') @include('home_page.script')
</body>
