...
<body> @include('@pages_all.admin_page.navbar') <div class="row-fluid"> @include('@pages_all.zerfe_page.sidebar_message') <div
   class="span6" id="content" style="margin-left:17%;">
   <div class="row-fluid">
    <!-- breadcrumb -->
     ...
     <div class="block-content collapse in">
      <div class="span12">
       <ul class="nav nav-pills">
        <li class="">
         <a href="{{route('zerfe.message')}}"><i class="icon-envelope-alt"></i>inbox</a>
        </li>
        <li class="active">
         <a href="{{route('zerfe.sent_message')}}"><i class="icon-envelope-alt"></i>Sent messages</a>
        </li>
       </ul> 
...
<div class="post" id="del{{$reciever->message_sent_id}}"> {{$reciever->content}}
        ...
        @include('@pages_all.zerfe_page.remove_sent_message_modal')
        </div>
       </div>
       @endforeach
