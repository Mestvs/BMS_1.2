...
<body> @include('@pages_all.admin_page.navbar') <div class="row-fluid"> @include('@pages_all.finance_page.sidebar_message') <div class="span6" id="content"
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            <ul class="nav nav-pills">
                                <li class="">
                                    <a href="{{ route('finance.message') }}"><i class="icon-envelope-alt"></i>inbox</a>
                                </li>
                                <li class="active">
                                    <a href="{{ route('finance.sent_message') }}"><i class="icon-envelope-alt"></i>Sent
                                        messages</a>
                                </li>
                            </ul> 
                                ...
                                @foreach ($recievers as $reciever)
                                    <div class="post" id="del{{ $reciever->message_sent_id }}">
                                        ...
                                        <i class="icon-calendar"></i> {{ $reciever->date_sended }} <div
                                            ...
                                            @include('@pages_all.finance_page.remove_sent_message_modal')
                                        </div>
                                    </div>
                                @endforeach
                            @else
        ...
        </div> @include('@pages_all.finance_page.create_message') </div>
    </div>@include('home_page.footer')
