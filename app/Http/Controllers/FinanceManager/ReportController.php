...
return view('@pages_all.Finance_Manager_page.generate_report', compact( 'message_unread','payment_year_query','payment_query','report','jan','feb','mar','apri','may','jun','jul','aug','sep','oct','nov','dec'));
...
$payment_year_query=DB::select('select distinct YEAR(paid_date) as year from payments order by year asc');
        ...
        $report='yes';
        return view('@pages_all.Finance_Manager_page.generate_report', compact( 'message_unread','year','payment_year_query','payment_query','report','jan','feb','mar','apri','may','jun','jul','aug','sep','oct','nov','dec'));
