...
<body>@include('@pages_all.admin_page.navbar')
    <div class="row-fluid" style="margin-bottom:15%;"> @include('@pages_all.limatekid_page.sidebar_dashboard')
        <div class="span9" id="content" style="margin-left:16%;">
            <div class="row-fluid">
                        ...
                        <div class="span12">
                            <form action="read.php" method="post">
                                <div class="alert alert-info"><strong
                                        style="font-style: normal;font-family: all;font-weight: normal;font-size: 18px"><i
                                            class="icon-info-sign"></i> {{ __('link.Notifications') }} </strong></div>
                                <div>
                                    <p
                ...
                <p
                    style="font-style: normal;font-family: all;
