...
<body>@include('@pages_all.admin_page.navbar')<div class="row-fluid"> @include('@pages_all.finance_page.sidebar_dashboard') <div class="span9" id="content"
                            ...
                            <form action="read.php" method="post">
                                ...
                                <div class="alert alert-info"><strong
                                        style="font-style: normal;font-family: all;font-weight: normal;font-size: 18px"><i
                                            class="icon-info-sign"></i> Notifications</strong></div>
                                <div>
                                    <p
