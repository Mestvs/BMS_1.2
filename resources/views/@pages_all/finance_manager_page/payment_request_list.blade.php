                ...
                <div id="block_bg" class="block">
                    <div class="navbar navbar-inner block-header">
                        <div class="pull-right " style="padding-top:0%;">
                            <a href="/fm_payment" id="print" class="btn btn-success" style="font-family: all;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="info"><small>Request Date:
                                                        ...
                                                        <p class="info"><small>Budget Category:
                                                            <b>{{ $payment->category_code}}</b></small>
                                                    </p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="info"><small>Date:
                                                        <b>{{ $payment->request_date }}</b></small>
                                                </p>
                                                <p class="info"><small>Budget Category:
                                                    <b>{{ $payment->category_code}}</b></small>
                                            </p>
                                            ...
                                            <td>
                                                <p class="info">Signature: <b
                                                        ...
                                                        href="{{ url('payment_approve_detail', $payment->request_id) }}"
                                                        data-toggle="modal" class="btn btn-success"><i
                                                            class=""></i>details</a></p>
                                                <p class="info"><small>Approval: <b
