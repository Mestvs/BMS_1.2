...
<body> @include('@pages_all.admin_page.navbar') <div class="row-fluid"> @include('@pages_all.admin_page.sidebar_message') <div class="span6" id="content"
                        ...
                        <div class="span12">
                            <form action="{{ route('read_message') }}" enctype="multipart/form-data" autocomplete="off"
                                ...
                                <ul class="nav nav-pills">
                                    <li class="active"><a href="/user_message"><i
                                                class="icon-envelope-alt"></i>inbox</a></li>
                                    <li class=""><a href="/sent_message"><i class="icon-envelope-alt"></i>Send
                                            messages</a></li>
                                </ul>
                                @if ($messages->count() > 0)
                                    @foreach ($messages as $message)
                                        <div class="post" id="del{{ $message->message_id }}">
                                            ...
                                            <i class="icon-calendar"></i> {{ $message->date_sended }} <div
                                                ...
                                                @include('@pages_all.admin_page.remove_inbox_message_modal')
                                            </div>
        ...
        </div>@include('@pages_all.admin_page.create_message') </div>
