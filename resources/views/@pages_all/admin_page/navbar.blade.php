                ...
                <ul class="nav pull-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="divider"></li>
                            <li>
                                <a href="/change_password"><i class="icon-circle"></i><b
                                        style="font-family: all;color: black;font-size: large;">
                                        {{ __('link.changepassword') }}
                                    </b> </a>
                                <a tabindex="-1" href="#myModal" data-toggle="modal"><i class="icon-picture"></i> <b
                                        style="font-family: all;color: black;font-size: large;">{{ __('link.changeprofile') }}
                                    </b> </a>
                            </li><?php $it = 'it';
                            $en = 'en'; ?>
                            <li>
