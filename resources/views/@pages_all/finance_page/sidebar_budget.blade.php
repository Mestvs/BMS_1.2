<div class="span3" id="sidebar" style="width:15%;background-color:dodgerblue; padding-bottom:100%;position:fixed">
    ...
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        <li> <a href="/Finance_home" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
                    class="icon-home"></i><b><strong>{{ __('link.home') }}</strong></b></a> </li>
        <li>
            <a href="/f_payment" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
                    class=" icon-gift " style="margin-right:4px;"></i><b><strong>{{ __('sidebar.payment') }}
                    </strong></b></a>
        </li>
        <li class="active">
            <a href="/finance_budget" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
                    class="icon-money " style="margin-right:4px;"></i><b><strong>
                        {{ __('sidebar.m_budget') }} </strong></b></a>
        </li>
        <li>
            <a href="/f_generate_report" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
                    class="icon-book"
                    style="margin-right:4px;"></i><b><strong>{{ __('sidebar.g_report') }}</strong></b></a>
        </li>
        <li>
            <a href="{{ route('finance.message') }}" style="font-family: all;font-size: 17px;"><i
                    class="icon-chevron-right"></i><i class="icon-envelope"></i><b>
