...
<body id="homepage"> @include('auth.password_expire_navbar')
    <div class="row-fluid">
                ...
                <div id="block_bg" class="block">
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <form method="post" action="{{ route('password.post_expired') }}" id="change_password"
    ...
    </div><br><br><br><br><br><br> @include('home_page.script')
</body>
