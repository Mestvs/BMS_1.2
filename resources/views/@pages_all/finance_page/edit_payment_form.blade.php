                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="alert alert-info" style="color: white;font-family: all;font-size:large;"><i
                                        class="icon-info-sign"></i>{{ __('payment.p_comparison_form') }} </div>
                            </div>
                            <div class="block-content collapse in" style="font-size:large ;">
                                <div class="span12">
                                    <div class="control-group"
                                        ...
                                        <div class="controls">
                                            <a href="{{url('/edit/payment',$payment->payment_id)}}"
                                                id="print"class="btn btn-success" style="font-family:all;"> <i
                                                    class="icon-plus">
                                                </i><b><strong> {{ __('payment.p_voucher') }}</strong></b></a>
                                        </div>
                                    </div>
                                    <form action="{{ url('/edit/payment', $payment->payment_id) }}" method="post"
                                        class="form-horizontal" autocomplete="off" id="voucher">
                                        @csrf
                                        <strong><b><i>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="description" cols="30" rows="5" readonly="true" id="comment"
                                                    style="border: double;color: black;font-family: all;" placeholder=" " required pattern="[a-zA-Z0-9_]{3,}">{{ $request->description }}
                                                    </textarea>
                                            </div>
                                        </div>
                                            ...
                                            <fieldset style="background-color:darkgray;">
                                                ...
                                                <div class="control-group"
                                                    ...
                                                    <div class="controls" style="margin-left:37% ;">
                                                        <input style="color:blue" class="input focused"
                                                            value="{{ $approval->signature_sign }}{{ $approval->approver_name }}
                                    ...
                                    <div class="control-group" style="clear:both ;">
                                        ...
                                        <div class="controls"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button
                                                ...
                                                style="color: black;font-family: all;"><i
                                                    class="icon-plus-sign"></i><b>{{ __('budget.b_update') }}
                                                </b></button>
                                        </div>
                                    </div>
                                </div>
