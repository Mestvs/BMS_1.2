<div class="span3" id="sidebar" style="width:15%;background-color:dodgerblue; padding-bottom:100%;position:fixed">
  ...
  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
   <li class="active"> <a href="/Finance_home" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
   ...
   <li>
    ...
    <a href="{{route('finance.message')}}" style="font-family: all;font-size: 17px;"><i class="icon-chevron-right"></i><i
