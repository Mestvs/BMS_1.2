@include('header')
<body> @include('@pages_all.admin_page.navbar') <div class="row-fluid"> @include('@pages_all.finance_manager_page.sidebar_message') <div
     ...
     <div class="block-content collapse in">
      <div class="span12">
       <ul class="nav nav-pills">
        <li class="">
         <a href="/fm_message"><i class="icon-envelope-alt"></i>inbox</a>
        </li>
        <li class="active">
         <a href="/fm_sent_message"><i class="icon-envelope-alt"></i>Sent messages</a>
        </li>
       </ul> 
...
<div class="post" id="del{{$reciever->message_sent_id}}"> {{$reciever->content}}
        ...
        @include('@pages_all.finance_manager_page.remove_sent_message_modal')
        </div>
       </div>
       @endforeach
...
@endif
  ...
  </div> @include('@pages_all.finance_manager_page.create_message') </div>  </div>@include('home_page.footer')
