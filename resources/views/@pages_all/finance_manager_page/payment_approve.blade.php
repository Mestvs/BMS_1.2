...
<body> @include('@pages_all.admin_page.navbar') <div class="row-fluid"> @include('@pages_all.finance_manager_page.sidebar_payment')<div class="span3" id="adduser"
            style="width:25%;margin-left:16%;"> @include('@pages_all.finance_manager_page.payment_request_approve_form')
        </div>
                                    ...
                                    <tbody>
                                        @foreach ($payment_request_selected as $request_selected)
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="info">Sign&Date:<b
                                                            style="color:green;">{{ $request_selected->signature }}</b>
                                                    </p>
                                                    <p class="info"><small>Approve&Date: <b
                                                                style="color:red;">{{ $request_selected->approval }}</b></small>
                                                    </p>
                                                </td>
                                            </tr>
                                        @endforeach
    ...
    </div><br><br> <br> <br>  @include('home_page.footer')@include('home_page.script') </body>
